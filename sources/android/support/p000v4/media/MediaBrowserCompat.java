            ...
            if (weakReference != null && weakReference.get() != null && this.mCallbackImplRef.get() != null) {
                ...
                try {
                    ...
                    if (i == 1) {
                        ...
                        serviceCallback.onServiceConnected(callbacksMessenger, data.getString(str2), (Token) data.getParcelable(MediaBrowserProtocol.DATA_MEDIA_SESSION_TOKEN), rootHints);
                    } else if (i == 2) {
                        ...
                        serviceCallback.onLoadChildren(callbacksMessenger, data.getString(str2), data.getParcelableArrayList(MediaBrowserProtocol.DATA_MEDIA_ITEM_LIST), options, notifyChildrenChangedOptions);
                    }

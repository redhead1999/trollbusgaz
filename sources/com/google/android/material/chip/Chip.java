...
public class Chip extends AppCompatCheckBox implements Delegate {
        ...
        public void onPopulateNodeForVirtualView(int virtualViewId, AccessibilityNodeInfoCompat node) {
            ...
            if (access$100) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    int i = C0460R.string.mtrl_chip_close_icon_content_description;
    ...
    public Chip(Context context, AttributeSet attrs) {
        this(context, attrs, C0460R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ChipDrawable drawable = ChipDrawable.createFromAttributes(context, attrs, defStyleAttr, C0460R.style.Widget_MaterialComponents_Chip_Action);

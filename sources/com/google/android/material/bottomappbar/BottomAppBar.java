...
public class BottomAppBar extends Toolbar implements AttachedBehavior {
    ...
    public BottomAppBar(Context context, AttributeSet attrs) {
        this(context, attrs, C0460R.attr.bottomAppBarStyle);
    }
    ...
    public BottomAppBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, C0460R.styleable.BottomAppBar, defStyleAttr, C0460R.style.Widget_MaterialComponents_BottomAppBar, new int[0]);
        ColorStateList backgroundTint = MaterialResources.getColorStateList(context, a, C0460R.styleable.BottomAppBar_backgroundTint);
        float fabCradleMargin = (float) a.getDimensionPixelOffset(C0460R.styleable.BottomAppBar_fabCradleMargin, 0);
        float fabCornerRadius = (float) a.getDimensionPixelOffset(C0460R.styleable.BottomAppBar_fabCradleRoundedCornerRadius, 0);
        float fabVerticalOffset = (float) a.getDimensionPixelOffset(C0460R.styleable.BottomAppBar_fabCradleVerticalOffset, 0);
        this.fabAlignmentMode = a.getInt(C0460R.styleable.BottomAppBar_fabAlignmentMode, 0);
        this.hideOnScroll = a.getBoolean(C0460R.styleable.BottomAppBar_hideOnScroll, false);
        a.recycle();
        this.fabOffsetEndMode = getResources().getDimensionPixelOffset(C0460R.dimen.mtrl_bottomappbar_fabOffsetEndMode);

...
public class BottomNavigationItemView extends FrameLayout implements ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setBackgroundResource(C0460R.C0461drawable.design_bottom_navigation_item_background);
        this.defaultMargin = res.getDimensionPixelSize(C0460R.dimen.design_bottom_navigation_margin);
        this.icon = (ImageView) findViewById(C0460R.C0462id.icon);
        this.smallLabel = (TextView) findViewById(C0460R.C0462id.smallLabel);
        this.largeLabel = (TextView) findViewById(C0460R.C0462id.largeLabel);

...
public class Scene {
    ...
    public static Scene getSceneForLayout(ViewGroup sceneRoot, int layoutId, Context context) {
        SparseArray sparseArray = (SparseArray) sceneRoot.getTag(C0418R.C0420id.transition_scene_layoutid_cache);
        if (sparseArray == null) {
            sparseArray = new SparseArray();
            sceneRoot.setTag(C0418R.C0420id.transition_scene_layoutid_cache, sparseArray);
        }
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(C0418R.C0420id.transition_current_scene, scene);
    }

    static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(C0418R.C0420id.transition_current_scene);
    }

...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0039R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0039R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0039R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0039R.styleable.ActionBar_height, -1);
        if (getId() == C0039R.C0041id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0039R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        boolean z = false;

...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            int itemViewType = getItemViewType(position);
            if (itemViewType == 0) {
                if (convertView == null || convertView.getId() != C0039R.C0041id.list_item) {
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0039R.layout.abc_activity_chooser_view_list_item, parent, false);
                }
                PackageManager packageManager = ActivityChooserView.this.getContext().getPackageManager();
                ResolveInfo activity = (ResolveInfo) getItem(position);
                ((ImageView) convertView.findViewById(C0039R.C0041id.icon)).setImageDrawable(activity.loadIcon(packageManager));
                ((TextView) convertView.findViewById(C0039R.C0041id.title)).setText(activity.loadLabel(packageManager));
                ...
                if (convertView == null || convertView.getId() != 1) {
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0039R.layout.abc_activity_chooser_view_list_item, parent, false);
                    convertView.setId(1);
                    ((TextView) convertView.findViewById(C0039R.C0041id.title)).setText(ActivityChooserView.this.getContext().getString(C0039R.string.abc_activity_chooser_view_see_all));
                }
                return convertView;
            } else {
                throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C0039R.styleable.ActivityChooserView, defStyle, 0);
        if (VERSION.SDK_INT >= 29) {
            saveAttributeDataForStyleable(context, C0039R.styleable.ActivityChooserView, attrs, attributesArray, defStyle, 0);
        }
        this.mInitialActivityCount = attributesArray.getInt(C0039R.styleable.ActivityChooserView_initialActivityCount, 4);
        Drawable expandActivityOverflowButtonDrawable = attributesArray.getDrawable(C0039R.styleable.ActivityChooserView_expandActivityOverflowButtonDrawable);
        ...
        FrameLayout expandButton = (FrameLayout) findViewById(C0039R.C0041id.expand_activities_button);
        ...
        this.mExpandActivityOverflowButtonImage = (ImageView) expandButton.findViewById(C0039R.C0041id.image);
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        if (this.mAdapter.getDataModel() != null) {
            ...
            if (!popupWindow.isShowing()) {
                ...
                popupWindow.getListView().setContentDescription(getContext().getString(C0039R.string.abc_activitychooserview_choose_application));
